...
#ifndef _SHORTCUT_BOX_HANDLER_H__
#define _SHORTCUT_BOX_HANDLER_H__


#include "ServerGuiBase.h"

//! take care of update comming from client ShortcutBox GUI
class ShortcutBoxHandler :	public ServerGUIBase
{
public:
	//! constructor
