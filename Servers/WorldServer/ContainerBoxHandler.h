...
#ifndef _CONTAINER_BOX_HANDLER_H__
#define _CONTAINER_BOX_HANDLER_H__


#include "ServerGuiBase.h"

//! take care of update comming from client ContainerBox GUI
class ContainerBoxHandler :	public ServerGUIBase
{
public:
	//! constructor
