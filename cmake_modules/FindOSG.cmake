...
find_path(OSG_INCLUDE_DIR osg/Node
          ...
          PATHS ${3RD_PARTY_PATH}/OSG/include dependencies/OpenSceneGraph/include
          PATH_SUFFIXES osg )          
...
IF (OSG_CORE_LIBRARY_RELEASE AND NOT OSG_CORE_LIBRARY_DEBUG)
  ...
  SET(OSG_QT_LIBRARY_DEBUG ${OSG_QT_LIBRARY_RELEASE})
...
set(OSG_LIBRARIES debug ${OSG_CORE_LIBRARY_DEBUG} debug ${OSG_UTIL_LIBRARY_DEBUG} debug ${OSG_GA_LIBRARY_DEBUG} debug ${OSG_VIEWER_LIBRARY_DEBUG} debug ${OSG_DB_LIBRARY_DEBUG} debug ${OSG_TEXT_LIBRARY_DEBUG} debug ${OSG_SHADOW_LIBRARY_DEBUG} debug ${OSG_PARTICLE_LIBRARY_DEBUG} debug ${OSG_MANIPULATOR_LIBRARY_DEBUG} debug ${OSG_QT_LIBRARY_DEBUG} debug ${OSG_AUDIO_LIBRARY_DEBUG} debug ${OSG_OPENTHREAD_LIBRARY_DEBUG}
		optimized ${OSG_CORE_LIBRARY_RELEASE} optimized ${OSG_UTIL_LIBRARY_RELEASE} optimized ${OSG_GA_LIBRARY_RELEASE} optimized ${OSG_VIEWER_LIBRARY_RELEASE} optimized ${OSG_DB_LIBRARY_RELEASE} optimized ${OSG_TEXT_LIBRARY_RELEASE} optimized ${OSG_SHADOW_LIBRARY_RELEASE} optimized ${OSG_PARTICLE_LIBRARY_RELEASE} optimized ${OSG_MANIPULATOR_LIBRARY_RELEASE} optimized ${OSG_QT_LIBRARY_RELEASE} optimized ${OSG_AUDIO_LIBRARY_RELEASE} optimized ${OSG_OPENTHREAD_LIBRARY_RELEASE})
...
find_package_handle_standard_args(OSG DEFAULT_MSG
				OSG_CORE_LIBRARY_DEBUG OSG_UTIL_LIBRARY_DEBUG OSG_GA_LIBRARY_DEBUG OSG_VIEWER_LIBRARY_DEBUG OSG_DB_LIBRARY_DEBUG OSG_TEXT_LIBRARY_DEBUG OSG_SHADOW_LIBRARY_DEBUG OSG_PARTICLE_LIBRARY_DEBUG OSG_MANIPULATOR_LIBRARY_DEBUG OSG_QT_LIBRARY_DEBUG OSG_AUDIO_LIBRARY_DEBUG OSG_OPENTHREAD_LIBRARY_DEBUG
                                  OSG_CORE_LIBRARY_RELEASE OSG_UTIL_LIBRARY_RELEASE OSG_GA_LIBRARY_RELEASE OSG_VIEWER_LIBRARY_RELEASE OSG_DB_LIBRARY_RELEASE OSG_TEXT_LIBRARY_RELEASE OSG_SHADOW_LIBRARY_RELEASE OSG_PARTICLE_LIBRARY_RELEASE OSG_MANIPULATOR_LIBRARY_RELEASE OSG_QT_LIBRARY_RELEASE OSG_AUDIO_LIBRARY_RELEASE OSG_OPENTHREAD_LIBRARY_RELEASE
                                  OSG_INCLUDE_DIR)
