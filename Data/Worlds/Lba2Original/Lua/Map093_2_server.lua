function InitMap(environment)
	...
	Spawn_1:SetPosY(5)
	Spawn_1:SetPosZ(42)
	Spawn_1:SetName("from_souvenir")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map93.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map93.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_souvenir", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 3, 8, 1, true)
	Trigger_1:SetPosition(18.5, 5, 45.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map092_2")
