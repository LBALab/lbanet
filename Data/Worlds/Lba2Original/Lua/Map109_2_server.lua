function InitMap(environment)
	...
	Spawn_3:SetPosY(0)
	Spawn_3:SetPosZ(9)
	Spawn_3:SetName("from_15")
	environment:AddSpawn(Spawn_3)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map109.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map109.phy"
	...
	Trigger_2_info = TriggerInfo(2, "to_15", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 1, 7, 2, true)
	Trigger_2:SetPosition(18.5, 0, 9)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("Map110_2")
