function InitMap(environment)
	...
	Spawn_3:SetPosY(0)
	Spawn_3:SetPosZ(2)
	Spawn_3:SetName("from_cop2")
	Spawn_3:SetForceRotation(true)
	Spawn_3:SetRotation(0)
	environment:AddSpawn(Spawn_3)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map52.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map52.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_cop1", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 1, 7, 2, true)
	Trigger_1:SetPosition(0.5, 0, 4)
	...
	Trigger_2_info = TriggerInfo(2, "to_cop2", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 2, 7, 1, true)
	Trigger_2:SetPosition(4, 0, 0.5)
	...
	Trigger_3_info = TriggerInfo(3, "to_jail", true, true, false)
	Trigger_3 = ZoneTrigger(Trigger_3_info, 3, 8, 1, true)
	Trigger_3:SetPosition(9.5, 0, 11.5)
	Trigger_3_act1 = TeleportAction()
	Trigger_3_act1:SetMapName("Map053_2")
