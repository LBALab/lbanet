function InitMap(environment)
	...
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map108.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map108.phy"
	...
	Trigger_2_info = TriggerInfo(2, "to_14", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 1, 7, 2, true)
	Trigger_2:SetPosition(18.5, 0, 9)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("Map109_2")
	Trigger_2_act1:SetSpawning(1)
	Trigger_2:SetAction1(Trigger_2_act1)
	environment:AddTrigger(Trigger_2)

	Trigger_3_info = TriggerInfo(3, "to_biggie", true, true, false)
	Trigger_3 = ZoneTrigger(Trigger_3_info, 4, 7, 1, true)
	Trigger_3:SetPosition(11, 0, 1.5)
	Trigger_3_act1 = TeleportAction()
	Trigger_3_act1:SetMapName("Map049_2")
