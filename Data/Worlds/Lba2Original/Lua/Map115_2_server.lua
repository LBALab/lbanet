function InitMap(environment)
	...
	Spawn_1:SetPosX(9)
	Spawn_1:SetPosY(0)
	Spawn_1:SetPosZ(10.5)
	Spawn_1:SetName("from_hotel")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 750
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map115.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map115.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_hotel", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 2, 8, 1, true)
	Trigger_1:SetPosition(9, 0, 12.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map050_2")
