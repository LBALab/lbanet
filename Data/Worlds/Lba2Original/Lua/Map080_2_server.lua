function InitMap(environment)
	...
	Spawn_1:SetPosY(4)
	Spawn_1:SetPosZ(9)
	Spawn_1:SetName("from_club")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map80.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map80.phy"
	...
	Trigger_1:SetPosition(13, 4, 11.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map082_2")
