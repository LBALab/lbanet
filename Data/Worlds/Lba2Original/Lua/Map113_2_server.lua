function InitMap(environment)
	...
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map113.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map113.phy"
	...
	Trigger_1:SetPosition(63.5, 1, 37)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("EMERAUDE")
	Trigger_1_act1:SetSpawning(4)
	Trigger_1:SetAction1(Trigger_1_act1)
	environment:AddTrigger(Trigger_1)

	Trigger_2_info = TriggerInfo(2, "to_tech", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 1, 8, 2, true)
	Trigger_2:SetPosition(48.5, 1, 37)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("Map024_2")
