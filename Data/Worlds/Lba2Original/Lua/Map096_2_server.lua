function InitMap(environment)
	...
	Spawn_2:SetPosY(0)
	Spawn_2:SetPosZ(3)
	Spawn_2:SetName("from_5")
	environment:AddSpawn(Spawn_2)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map96.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map96.phy"
	...
	Trigger_2_info = TriggerInfo(2, "to_5", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 2, 7, 1, true)
	Trigger_2:SetPosition(11, 0, 1.5)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("Map100_2")
