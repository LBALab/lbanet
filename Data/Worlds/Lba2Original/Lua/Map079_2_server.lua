function InitMap(environment)
	...
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map79.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map79.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_casino", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 1, 8, 2, true)
	Trigger_1:SetPosition(56.5, 6, 46)
	...
	Trigger_2_info = TriggerInfo(2, "to_otringal", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 1, 8, 2, true)
	Trigger_2:SetPosition(34.5, 5.9, 53)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("OTRINGAL")
	Trigger_2_act1:SetSpawning(16)
