function InitMap(environment)
	...
	Spawn_2:SetPosY(0)
	Spawn_2:SetPosZ(7.5)
	Spawn_2:SetName("from_dissidents")
	environment:AddSpawn(Spawn_2)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map92.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map92.phy"
	...
	Trigger_1:SetPosition(4.5, 2, 18)
	...
	Trigger_2_info = TriggerInfo(2, "to_dissidents", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 3, 8, 1, true)
	Trigger_2:SetPosition(15.5, 0, 5.5)
	Trigger_2_act1 = TeleportAction()
	Trigger_2_act1:SetMapName("Map093_2")
