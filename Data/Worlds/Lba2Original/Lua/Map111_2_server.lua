function InitMap(environment)
	...
	Spawn_2:SetPosY(0)
	Spawn_2:SetPosZ(15)
	Spawn_2:SetName("from_12")
	environment:AddSpawn(Spawn_2)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map111.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map111.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_12", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 2, 7, 1, true)
	Trigger_1:SetPosition(11, 0, 16.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map107_2")
