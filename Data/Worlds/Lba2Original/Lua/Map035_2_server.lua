function InitMap(environment)
	...
	Spawn_1:SetPosY(0)
	Spawn_1:SetPosZ(10)
	Spawn_1:SetName("from_sewer")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = -1163005939
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map35.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map35.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_sewer", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 2, 8, 2, true)
	Trigger_1:SetPosition(20, 0, 10)
