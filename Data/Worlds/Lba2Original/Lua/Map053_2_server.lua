function InitMap(environment)
	...
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map53.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map53.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_copbox", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 3, 8, 1, true)
	Trigger_1:SetPosition(9.5, 3, 11.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map052_2")
	Trigger_1_act1:SetSpawning(1)
	Trigger_1:SetAction1(Trigger_1_act1)
	environment:AddTrigger(Trigger_1)

	Trigger_2_info = TriggerInfo(2, "to_copback", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 3, 8, 1, true)
	Trigger_2:SetPosition(19.5, 3, 21.5)
