function InitMap(environment)
	...
	Spawn_1:SetPosY(3)
	Spawn_1:SetPosZ(61)
	Spawn_1:SetName("from_baggagesecond")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = -1163005939
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map17.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map17.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_baggagesecond", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 2.1, 7, 1, true)
	Trigger_1:SetPosition(32, 3, 63.5)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map007_2")
