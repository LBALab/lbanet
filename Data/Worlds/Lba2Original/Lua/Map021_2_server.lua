function InitMap(environment)
	...
	Spawn_1:SetPosY(5)
	Spawn_1:SetPosZ(61)
	Spawn_1:SetName("from_tralumain")
	...
	Spawn_2:SetPosY(15)
	Spawn_2:SetPosZ(5)
	Spawn_2:SetName("from_traluthird")
	...
	Trigger_1_info = TriggerInfo(1, "to_tralumain", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 3, 8, 1, true)
	Trigger_1:SetPosition(57.2, 5, 63.5)
	...
	Trigger_2_info = TriggerInfo(2, "to_traluthird", true, true, false)
	Trigger_2 = ZoneTrigger(Trigger_2_info, 1, 8, 4, true)
	Trigger_2:SetPosition(45.5, 15, 4.6)
