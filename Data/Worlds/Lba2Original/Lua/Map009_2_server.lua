function InitMap(environment)
	...
	Spawn_0:SetPosY(3)
	Spawn_0:SetPosZ(10)
	Spawn_0:SetName("citade_ticket")
	environment:AddSpawn(Spawn_0)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = -1163005939
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map9.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map9.phy"
	...
	Trigger_1_info = TriggerInfo(1, "ticket_cita", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 2, 8, 1, true)
	Trigger_1:SetPosition(6, 3, 11.5)
