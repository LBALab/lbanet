function InitMap(environment)
	...
	Spawn_3:SetPosY(0)
	Spawn_3:SetPosZ(9)
	Spawn_3:SetName("from_4")
	environment:AddSpawn(Spawn_3)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Lba2Original/Grids/Map98.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Lba2Original/Grids/Map98.phy"
	...
	Trigger_1_info = TriggerInfo(1, "to_2", true, true, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 1, 7, 2, true)
	Trigger_1:SetPosition(3.5, 0, 9)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Map097_2")
	...
	Trigger_2:SetPosition(11, 0, 1.5)
	...
	Trigger_3_info = TriggerInfo(3, "to_4", true, true, false)
	Trigger_3 = ZoneTrigger(Trigger_3_info, 1, 7, 2, true)
	Trigger_3:SetPosition(18.5, 0, 9)
	Trigger_3_act1 = TeleportAction()
	Trigger_3_act1:SetMapName("Map099_2")
