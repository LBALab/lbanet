function InitMap(environment)
	...
	Spawn_1:SetPosZ(36)
	Spawn_1:SetName("fromsquare")
	environment:AddSpawn(Spawn_1)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Colozen/Grids/ColobeeMountain/VillageHouse1.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Colozen/Grids/ColobeeMountain/VillageHouse1.phy"
	...
	Trigger_1_info = TriggerInfo(1, "tosquare", true, false, false)
	Trigger_1 = ZoneTrigger(Trigger_1_info, 1, 4, 2, true)
	Trigger_1:SetPosition(62.5, 3, 36)
	Trigger_1:SetStayUpdateFrequency(-1)
	Trigger_1_act1 = TeleportAction()
	Trigger_1_act1:SetMapName("Colobee_Village_Square")
	...
	Trigger_2:SetPosition(40, 3, 32)
	Trigger_2_act1 = ClientScriptAction()
	Trigger_2_act1_cs = GoUpLadderScript()
	Trigger_2_act1_cs:SetLadderPositionX(40)
	Trigger_2_act1_cs:SetLadderPositionY(3)
	Trigger_2_act1_cs:SetLadderPositionZ(32)
	...
	Trigger_3:SetPosition(40, 3, 24)
	Trigger_3_act1 = ClientScriptAction()
	Trigger_3_act1_cs = GoUpLadderScript()
	Trigger_3_act1_cs:SetLadderPositionX(40)
	Trigger_3_act1_cs:SetLadderPositionY(3)
	Trigger_3_act1_cs:SetLadderPositionZ(24)
	Trigger_3_act1_cs:SetLadderHeight(4)
