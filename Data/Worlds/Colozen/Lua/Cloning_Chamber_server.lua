function InitMap(environment)
	...
	Spawn_2:SetPosZ(44)
	Spawn_2:SetName("door1")
	environment:AddSpawn(Spawn_2)

	Actor_1 = ActorObjectInfo(1)
	Actor_1:SetRenderType(1)
	Actor_1.DisplayDesc.ModelId = 0
	Actor_1.DisplayDesc.ModelName = "Worlds/Colozen/Grids/ColobeeMountain/start1.osgb"
	...
	Actor_1.PhysicDesc.Filename = "Worlds/Colozen/Grids/ColobeeMountain/start1.phy"
	...
	Trigger_1:SetPosition(0.5, 2, 44)
