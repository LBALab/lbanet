function InitMap(environment)
	...
	Spawn_7:SetPosY(4)
	Spawn_7:SetPosZ(41)
	Spawn_7:SetName("boatfromprincipal")
	Spawn_7_act1 = ClientScriptAction()
	Spawn_7_act1_cs = CustomScript()
	Spawn_7_act1_cs:SetLuaFunctionName("UseBoatCitadelFromPrincipal")
	Spawn_7_act1:SetScript(Spawn_7_act1_cs)
	Spawn_7:SetActionAtArrival(Spawn_7_act1)
	...
	Actor_11H_dia_c0 = DialogPart()
	Actor_11H_dia_c0_cond = QuestAvailableCondition()
	Actor_11H_dia_c0_cond:SetTextid(-1)
	Actor_11H_dia_c0_cond:SetQuestId(3)
	Actor_11H_dia_c0:Setcondition(Actor_11H_dia_c0_cond)
	Actor_11H_dia_c0:SetResetDialog(false)
	Actor_11H_dia_c0:AddText(207)
	Actor_11H_dia_c0_c0 = DialogPart()
	Actor_11H_dia_c0_c0_act = StartQuestAction()
	Actor_11H_dia_c0_c0_act:SetQuestId(3)
	Actor_11H_dia_c0_c0:SetAction(Actor_11H_dia_c0_c0_act)
	Actor_11H_dia_c0_c0:SetResetDialog(false)
	Actor_11H_dia_c0_c0:AddText(1049)
	Actor_11H_dia_c0:AddChild(Actor_11H_dia_c0_c0)
	Actor_11H_dia:AddChild(Actor_11H_dia_c0)
	Actor_11H_dia_c1 = DialogPart()
	Actor_11H_dia_c1_cond = QuestStartedCondition()
	Actor_11H_dia_c1_cond:SetTextid(-1)
	Actor_11H_dia_c1_cond:SetQuestId(3)
	Actor_11H_dia_c1:Setcondition(Actor_11H_dia_c1_cond)
	Actor_11H_dia_c1:SetResetDialog(false)
	Actor_11H_dia_c1:AddText(1047)
	Actor_11H_dia_c1_c0 = DialogPart()
	Actor_11H_dia_c1_c0_cond = QuestFinishedCondition()
	Actor_11H_dia_c1_c0_cond:SetTextid(-1)
	Actor_11H_dia_c1_c0_cond:SetQuestId(4)
	Actor_11H_dia_c1_c0:Setcondition(Actor_11H_dia_c1_c0_cond)
	Actor_11H_dia_c1_c0_act = FinishQuestAction()
	Actor_11H_dia_c1_c0_act:SetQuestId(3)
	Actor_11H_dia_c1_c0:SetAction(Actor_11H_dia_c1_c0_act)
	Actor_11H_dia_c1_c0:SetResetDialog(false)
	Actor_11H_dia_c1_c0:AddText(1041)
	Actor_11H_dia_c1:AddChild(Actor_11H_dia_c1_c0)
	Actor_11H_dia:AddChild(Actor_11H_dia_c1)
	...
	Actor_12H:SetAttackActiDist(6)
	Actor_12H:SetAttackActiDistDiscrete(4)
	Actor_12H:SetAttackActiDistHidden(2)
	Actor_12H:SetAttackStopDist(16)
	Actor_12H:SetRespawnTimeInSec(10)
	Actor_12H:SetWeaponAnimAtStart(true)
	Actor_12H:SetWeapon1Type(1)
	Actor_12H:SetWeapon1Power(10)
	Actor_12H:SetWeapon1ReachDistance(2)
	Actor_12H:Setuseweapon1animation("Use1Weapon")
	Actor_12H:SetWeapon2Type(2)
	Actor_12H:SetWeapon2Power(0)
	Actor_12H:SetWeapon2ReachDistance(1)
	Actor_12H:Setuseweapon2animation("UseWeapon")
	Actor_12H:SetAttackFunction("ActorAttackContactPlayer")
	Actor_12H:Setchasinganimation("Run")
	Actor_12H:AddGivenItem(1,1,1,0.3,1)
	Actor_12H:AddGivenItem(2,1,1,0.3,1)
	Actor_12H:AddGivenItem(8,2,2,0.4,1)
	Actor_12H:AddGivenItem(3,1,1,0.05,2)
	...
	Actor_15H_dia_c0 = DialogPart()
	Actor_15H_dia_c0:SetResetDialog(false)
	Actor_15H_dia_c0:AddText(257)
	Actor_15H_dia_c0_c0 = DialogPart()
	Actor_15H_dia_c0_c0_act = OpenShopAction()
	Actor_15H_dia_c0_c0_act:SetCurrencyItem(8)
	Actor_15H_dia_c0_c0_act:AddItem(12, 10)
	Actor_15H_dia_c0_c0:SetAction(Actor_15H_dia_c0_c0_act)
	Actor_15H_dia_c0_c0:SetResetDialog(false)
	Actor_15H_dia_c0_c0:AddText(1060)
	Actor_15H_dia_c0:AddChild(Actor_15H_dia_c0_c0)
	Actor_15H_dia:AddChild(Actor_15H_dia_c0)
	...
	Trigger_13_info = TriggerInfo(13, "takeboattoprincipal", true, true, false)
	Trigger_13 = ZoneActionTrigger(Trigger_13_info, 3, 2, 3, "Normal", "None")
	Trigger_13:SetPosition(22, 4, 40.1)
	Trigger_13_act1 = ConditionalAction()
	Trigger_13_act1_act1 = MultiAction()
	Trigger_13_act1_act1_act0 = AddRemoveItemAction()
	Trigger_13_act1_act1_act0:SetItemId(12)
	Trigger_13_act1_act1_act0:SetNumber(-1)
	Trigger_13_act1_act1_act0:SetInformClientType(1)
	Trigger_13_act1_act1:AddAction(Trigger_13_act1_act1_act0)
	Trigger_13_act1_act1_act1 = ClientScriptAction()
	Trigger_13_act1_act1_act1_cs = CustomScript()
	Trigger_13_act1_act1_act1_cs:SetLuaFunctionName("UseBoatCitadelToPrincipal")
	Trigger_13_act1_act1_act1:SetScript(Trigger_13_act1_act1_act1_cs)
	Trigger_13_act1_act1:AddAction(Trigger_13_act1_act1_act1)
	Trigger_13_act1:SetActionTrue(Trigger_13_act1_act1)
	Trigger_13_act1_act2 = DisplayTextAction()
	Trigger_13_act1_act2:SetTextId(205)
	Trigger_13_act1:SetActionFalse(Trigger_13_act1_act2)
	Trigger_13_act1_cond = ItemInInventoryCondition()
	Trigger_13_act1_cond:SetTextid(-1)
	Trigger_13_act1_cond:SetItemId(12)
	Trigger_13_act1_cond:SetItemNumber(1)
	Trigger_13_act1:SetCondition(Trigger_13_act1_cond)
