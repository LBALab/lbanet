function InitMap(environment)
	...
	Trigger_1 = ZoneTrigger(Trigger_1_info, 1, 4, 9, true)
	...
	Trigger_7_act1:SetSpawning(4)
	Trigger_7:SetAction1(Trigger_7_act1)
	environment:AddTrigger(Trigger_7)

	Trigger_8_info = TriggerInfo(8, "myexit1", true, false, false)
	Trigger_8 = ZoneTrigger(Trigger_8_info, 1, 4, 3, true)
	Trigger_8:SetPosition(11.5, 0, 31.5)
	Trigger_8:SetStayUpdateFrequency(-1)
	Trigger_8_act1 = TeleportAction()
	Trigger_8_act1:SetMapName("MyMap0_1")
